        ...
        },
        {
          ...
          body: (
            <>
              ...
              <p>
                <strong>Ώρες υποστήριξης:</strong> Δευτέρα–Παρασκευή, 10:00–16:00 (ώρα
        ...
        },
        {
          ...
          body: (
            <p>
              ...
              που έχουν χαρακτηριστεί ως πειραματικές, (δ) διακοπές των τρίτων
              υπηρεσιών που η Πλατφόρμα χρησιμοποιεί για επιμέρους λειτουργίες
              (πάροχος υποδομής Hetzner, αποστολή email μέσω Brevo, τηλεδιάσκεψη
              μέσω Jitsi, feed ενημερώσεων του Kalypsis Desktop μέσω GitHub) —
              όταν πέσουν αυτοί οι πάροχοι, η αντίστοιχη λειτουργία σταματά μέχρι
              να αποκατασταθούν.
            </p>
          )
        }
