          ...
          <Box>
            <Stack direction="row" alignItems="center" spacing={0.5}>
              ...
              <HelpHint title="Πώς λειτουργούν οι κανόνες"
                body="Ορίστε τη συνολική προμήθεια που λαμβάνει η έδρα από την ασφαλιστική και το ποσοστό συνεργάτη ανά εταιρία, κλάδο, κάλυψη ή χρήση. Οι υπολογισμοί γίνονται στα καθαρά: συνολικό ποσοστό έδρας μείον συνεργάτης = υπόλοιπο έδρας." />
            </Stack>
            <Typography color="text.secondary">
              Ορίστε τη συνολική προμήθεια που λαμβάνει η έδρα από την ασφαλιστική επί των καθαρών. Αν υπάρχει συνεργάτης, το ποσοστό του αφαιρείται από αυτό το σύνολο και το υπόλοιπο μένει στην έδρα. Χωρίς συνεργάτη, όλο το σύνολο ανήκει στην έδρα.
            </Typography>
          </Box>
        </Stack>
      ...
      <DialogContent>
        ...
        <Stack spacing={2.5} mt={1}>
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
            <TextField type="number" label="Συνολική προμήθεια έδρας από ασφαλιστική %" value={form.agencyPercent}
