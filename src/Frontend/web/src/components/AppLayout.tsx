...
/**
 * Ν. 4583/2018 footer — removed on request. The obligation to display
 * the TtE registration number stays on any external-facing artefacts
 * (client-portal footer, printed έντυπα, contracts), but the internal
 * app chrome no longer surfaces it since staff already know it.
 */
