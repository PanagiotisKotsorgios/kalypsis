...
// AccessibilityWidget's visual language (56px navy circle) but pins to the
// bottom-left so the two utility controls don't stack. Clicking dispatches
  ...
  return (
    ...
    >
      <IconButton
        ...
        sx={{
          position: "fixed", left: 16, bottom: 16, zIndex: 1500,
